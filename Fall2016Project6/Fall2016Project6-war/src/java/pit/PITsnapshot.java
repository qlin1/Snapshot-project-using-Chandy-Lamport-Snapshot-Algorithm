    ...
    private void resetAllPlayers(int numPlayers, int action) {
        ...
        try {
            ...
            for (int player = 0; player < numPlayers; player++) {
                System.out.println(DateFormat.getTimeInstance().format(new Date()) + " Reset "+actionString+" of PITplayer" + player);
                ...
                System.out.println(DateFormat.getTimeInstance().format(new Date()) + " Reset "+actionString+" of PITplayer" + player + " ACKNOWLEDGED");
            }
            session.close();
            con.close();
        } catch (JMSException e) {
